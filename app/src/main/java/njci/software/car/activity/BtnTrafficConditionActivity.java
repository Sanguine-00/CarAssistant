...
//    private PoiNearbySearchOption nearbySearchOption;
    ...
    private static final String KEY = "b13753715d055c04a8d29b45cb570c4b";
    private static final String URL = "http://apis.juhe.cn/oil/region?";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_btn_traffic_condition);
        ButterKnife.bind(this);
        textHeadTitle.setText(R.string.home_tmc);
...
//        mLocCliOption.setIseedAltitude(true);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.imgPreference:
                    UIHelper.showBtnMapPreferenceSettingActivity(BtnTrafficConditionActivity.this);
                    break;
    ...
    public void startNavigation() {
        new Navigation(list, BtnTrafficConditionActivity.this);
    }
            ...
            if (bdLocation != null) {
                ...
                if (isFirstLoc) {
                    ...
                    MapStatus currentMapStatus = new MapStatus.Builder()
                            .target(mLoc).rotate(18f).zoom(12).build();
                    ...
                    getTrafficCondition(bdLocation.getLatitude(), bdLocation.getLongitude(), mCityName, bdLocation.getAddress().street);
                }
                mLoc = new LatLng(bdLocation.getLatitude(),
                        bdLocation.getLongitude());
                locData = new MyLocationData.Builder()
    ...
    private void getTrafficCondition(double la, double lo, String cityName, String roadName) {
        try {
            System.out.print(cityName + "..." + roadName);
            ...
            params.add("longitude", lo);// 经纬(如:121.538123)
            params.add("latitude", la);// 纬度(如：31.677132)
            params.add("key", KEY);// 应用APPKEY(应用详细页查询)
            params.add("cityName", cityName == null ? "南京市" : cityName);
            params.add("roadName", roadName);

            JuheData.executeWithAPI(getApplicationContext(), 209, "http://v.juhe.cn/trafficInfo/getTrafficInfoByName", JuheData.POST, params, new DataCallBack() {
    ...
    protected void ReadJSONDate(String response) {
        ...
        try {
            ...
            JSONObject trafficInfo = jsonObject.getJSONObject("traffic");
            JSONArray array = trafficInfo.getJSONArray("trendInfo");
            StringBuffer sb = null;
            for (int i = 0; i < array.length(); i++) {
                sb = new StringBuffer();
                JSONObject jsonData = (JSONObject) array.get(i);
                try {
                    sb.append(jsonData.getString(""));
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        try {
            if (isChecked) {
                UIHelper.ToastMessage(BtnTrafficConditionActivity.this, "打开路况");
                mBaiduMap.setTrafficEnabled(true);
            } else {
                UIHelper.ToastMessage(BtnTrafficConditionActivity.this, "关闭路况");
...
//            showProgressDialog();
                ...
                BaiduNaviManager.getInstance().init(mActivity, mSDCardPath,
                        APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
                            ...
                            public void onAuthResult(int status, String msg) {
                                ...
                                BtnTrafficConditionActivity.this.runOnUiThread(new Runnable() {

                                    @Override
                                    public void run() {
                                        Toast.makeText(BtnTrafficConditionActivity.this, authinfo,
                                                Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                            ...
                            public void initSuccess() {
                                Toast.makeText(BtnTrafficConditionActivity.this, "百度导航引擎初始化成功",
    ...
    //                            handlerGuide.sendEmptyMessage(0);
                            ...
                            public void initStart() {
                                Toast.makeText(BtnTrafficConditionActivity.this, "百度导航引擎初始化开始",
                                        Toast.LENGTH_SHORT).show();
                            }

                            public void initFailed() {
                                Toast.makeText(BtnTrafficConditionActivity.this, "百度导航引擎初始化失败",
                                        Toast.LENGTH_SHORT).show();
                            }
...
//    }
        ...
        public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
            ...
            public void onJumpToNavigator() {
                ...
                try {
                    Intent intent = new Intent(BtnTrafficConditionActivity.this,
                    ...
                    hideProgressDialog();
                    UIHelper.showBtnGuideActivity(BtnTrafficConditionActivity.this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
