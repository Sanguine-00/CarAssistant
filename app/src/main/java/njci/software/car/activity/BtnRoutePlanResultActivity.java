...
public class BtnRoutePlanResultActivity extends BaseFragmentActivity implements BaiduMap.OnMarkerClickListener, BaiduMap.OnMapClickListener, BaiduMap.OnPolylineClickListener, BDLocationListener, OnGetPoiSearchResultListener, OnGetRoutePlanResultListener, DialogInterface.OnCancelListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_route_plan_result);
...
//        mLocCliOption.setIseedAltitude(true);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.imgPreference:
                    UIHelper.showBtnMapPreferenceSettingActivity(BtnRoutePlanResultActivity.this);
                    break;
    ...
    public void startNavigation() {
        new Navigation(list, BtnRoutePlanResultActivity.this);
    }
        ...
        try {
            if (bdLocation != null) {
                ...
                if (isFirstLoc) {
                    ...
                    showDrivingRouteResult(ConstantValues.drivingRouteResult);
                }
                mLoc = new LatLng(bdLocation.getLatitude(),
                        bdLocation.getLongitude());
                locData = new MyLocationData.Builder()
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        try {
            if (isChecked) {
                UIHelper.ToastMessage(BtnRoutePlanResultActivity.this, "打开路况");
                mBaiduMap.setTrafficEnabled(true);
            } else {
                UIHelper.ToastMessage(BtnRoutePlanResultActivity.this, "关闭路况");
                mBaiduMap.setTrafficEnabled(false);
...
//            showProgressDialog();
                ...
                BaiduNaviManager.getInstance().init(mActivity, mSDCardPath,
                        APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
                            ...
                            public void onAuthResult(int status, String msg) {
                                ...
                                BtnRoutePlanResultActivity.this.runOnUiThread(new Runnable() {

                                    @Override
                                    public void run() {
                                        Toast.makeText(BtnRoutePlanResultActivity.this, authinfo,
                                                Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                            ...
                            public void initSuccess() {
                                Toast.makeText(BtnRoutePlanResultActivity.this, "百度导航引擎初始化成功",
    ...
    //                            handlerGuide.sendEmptyMessage(0);
                            ...
                            public void initStart() {
                                Toast.makeText(BtnRoutePlanResultActivity.this, "百度导航引擎初始化开始",
                                        Toast.LENGTH_SHORT).show();
                            }

                            public void initFailed() {
                                Toast.makeText(BtnRoutePlanResultActivity.this, "百度导航引擎初始化失败",
                                        Toast.LENGTH_SHORT).show();
                            }
...
//    }
        ...
        public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
            ...
            public void onJumpToNavigator() {
                ...
                try {
                    Intent intent = new Intent(BtnRoutePlanResultActivity.this,
                    ...
                    hideProgressDialog();
                    UIHelper.showBtnGuideActivity(BtnRoutePlanResultActivity.this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
//                startActivityForResult(intent, ConstantValues.NAVIGATION_REQUEST_CODE);
            }
