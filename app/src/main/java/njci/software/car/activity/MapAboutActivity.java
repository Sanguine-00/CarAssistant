...
//        mLocCliOption.setIseedAltitude(true);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.imgPreference:
                    UIHelper.showBtnMapPreferenceSettingActivity(MapAboutActivity.this);
                    break;
    ...
    public void startNavigation() {
        try {
            new Navigation(list, MapAboutActivity.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
                ...
                BaiduNaviManager.getInstance().init(mActivity, mSDCardPath,
                        APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
                            ...
                            public void onAuthResult(int status, String msg) {
                                ...
                                MapAboutActivity.this.runOnUiThread(new Runnable() {

                                    @Override
                                    public void run() {
                                        Toast.makeText(MapAboutActivity.this, authinfo,
                                                Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                            ...
                            public void initSuccess() {
                                Toast.makeText(MapAboutActivity.this, "百度导航引擎初始化成功",
                            ...
                            public void initStart() {
                                Toast.makeText(MapAboutActivity.this, "百度导航引擎初始化开始",
                                        Toast.LENGTH_SHORT).show();
                            }

                            public void initFailed() {
                                Toast.makeText(MapAboutActivity.this, "百度导航引擎初始化失败",
                                        Toast.LENGTH_SHORT).show();
                            }
        ...
        public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
            ...
            public void onJumpToNavigator() {
                ...
                try {
                    ...
                    Intent intent = new Intent(MapAboutActivity.this,
                    ...
                    hideProgressDialog();
                    UIHelper.showBtnGuideActivity(MapAboutActivity.this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
//                startActivity(intent);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if (isChecked) {
            UIHelper.ToastMessage(MapAboutActivity.this, "打开路况");
            mBaiduMap.setTrafficEnabled(true);
        } else {
            UIHelper.ToastMessage(MapAboutActivity.this, "关闭路况");
            mBaiduMap.setTrafficEnabled(false);
