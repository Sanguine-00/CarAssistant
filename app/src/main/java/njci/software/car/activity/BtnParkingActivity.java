...
public class BtnParkingActivity extends BaseFragmentActivity implements BaiduMap.OnMarkerClickListener, BaiduMap.OnMapClickListener, BaiduMap.OnPolylineClickListener, BDLocationListener, OnGetPoiSearchResultListener, OnGetRoutePlanResultListener, DialogInterface.OnCancelListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_parking);
        ButterKnife.bind(this);
        textHeadTitle.setText(R.string.home_parking);
        btnBack.setVisibility(View.VISIBLE);
        trafficCondition.setOnCheckedChangeListener(this);
        init();
...
//        mLocCliOption.setIseedAltitude(true);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.imgPreference:
                    UIHelper.showBtnMapPreferenceSettingActivity(BtnParkingActivity.this);
                    break;
    ...
    public void startNavigation() {
        new Navigation(list, BtnParkingActivity.this);
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        try {
            if (isChecked) {
                UIHelper.ToastMessage(BtnParkingActivity.this, "打开路况");
                mBaiduMap.setTrafficEnabled(true);
            } else {
                UIHelper.ToastMessage(BtnParkingActivity.this, "关闭路况");
                mBaiduMap.setTrafficEnabled(false);
        ...
        try {
            if (bdLocation != null) {
                ...
                if (isFirstLoc) {
                    ...
                    handler.sendEmptyMessage(ConstantValues.SUCCESS);
                }
                mLoc = new LatLng(bdLocation.getLatitude(),
                        bdLocation.getLongitude());
                locData = new MyLocationData.Builder()
        ...
        try {
            ...
            for (PoiInfo poiInfo : list) {
                ...
                bitmap = BitmapDescriptorFactory
                        .fromResource(R.drawable.navi_along_search_parking_icon);
...
//            showProgressDialog();
                ...
                BaiduNaviManager.getInstance().init(mActivity, mSDCardPath,
                        APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
                            ...
                            public void onAuthResult(int status, String msg) {
                                ...
                                BtnParkingActivity.this.runOnUiThread(new Runnable() {

                                    @Override
                                    public void run() {
                                        Toast.makeText(BtnParkingActivity.this, authinfo,
                                                Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                            ...
                            public void initSuccess() {
                                Toast.makeText(BtnParkingActivity.this, "百度导航引擎初始化成功",
    ...
    //                            handlerGuide.sendEmptyMessage(0);
                            ...
                            public void initStart() {
                                Toast.makeText(BtnParkingActivity.this, "百度导航引擎初始化开始",
                                        Toast.LENGTH_SHORT).show();
                            }

                            public void initFailed() {
                                Toast.makeText(BtnParkingActivity.this, "百度导航引擎初始化失败",
                                        Toast.LENGTH_SHORT).show();
                            }
...
//    }
        ...
        public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
            ...
            public void onJumpToNavigator() {
                ...
                try {
                    Intent intent = new Intent(BtnParkingActivity.this,
                    ...
                    hideProgressDialog();
                    UIHelper.showBtnGuideActivity(BtnParkingActivity.this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
